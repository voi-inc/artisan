...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision :chef_solo do |chef|
    chef.cookbooks_path = "/Users/jaridmargolin/Dropbox/firstopinion/dev/ops/chef/cookbooks"
    ...
    chef.json = {
      "package" => {
        :install => [
          "libpq-dev", # psycopg2
          "python-dev", # psycopg2
          "libxml2-dev", # premailer
          "libxslt-dev", # premailer
          "pandoc" # register.py
        ]
      },
      "pip" => {
        :install => [
          "psycopg2", # http://stackoverflow.com/questions/5420789/how-to-install-psycopg2-with-pip-on-python
          "pout",
          "pyt"
        ],
      },
